...
void ggml_cuda_out_prod(ggml_backend_cuda_context & ctx, ggml_tensor * dst) {
    ...
    if (src0->type == GGML_TYPE_F16) {
        ...
        to_fp32(src0->data, src0_f32.get(), n, stream);
        src0_d = src0_f32.get();
        // converted buffer is contiguous f32 with src0's logical shape
        lda = ne00;
        s02 = ne00*ne01;
        s03 = ne00*ne01*ne02;
    } else {
    ...
    // data strides in dimensions 2/3 (src0 strides s02/s03 set above, converted-aware)
