...
#undef CREATE_BINARY
    ...
    ggml_vk_create_pipeline(device, device->pipeline_out_prod_f16, "out_prod_f16", out_prod_f16_len, out_prod_f16_data, "main", 3, sizeof(vk_op_binary_push_constants), {256, 1, 1}, {}, 1);
